...
The generator intentionally writes docs/workspace/legacy-migration/generated/* only. It treats
...
def read_axdp_methods() -> list[Mapping]:
    ...
    for _, row in df.iterrows():
        ...
        rows.append(
            Mapping(
                source="docs/workspace/legacy-migration/evidence/AXDP设备能力协议集.xlsx:USB设备HID交互协议集",
                legacy_protocol="axdp_hid",
                legacy_id=legacy_id,
...
def read_vm33_methods() -> tuple[list[Mapping], list[Mapping], list[Mapping], list[dict[str, Any]]]:
    ...
    for _, row in df.iterrows():
        ...
        methods.append(
            Mapping(
                source="docs/workspace/legacy-migration/evidence/VM33_Protocol_V1_V2_Mapping.xlsx:V1_V2_Method_Mapping",
    ...
    for _, row in df.iterrows():
        ...
        events.append(
            Mapping(
                source="docs/workspace/legacy-migration/evidence/VM33_Protocol_V1_V2_Mapping.xlsx:Event_Subscribe_Mapping",
                legacy_protocol="vm33_http_json",
    ...
    for _, row in df.iterrows():
        ...
        caps.append(
            Mapping(
                source="docs/workspace/legacy-migration/evidence/VM33_Protocol_V1_V2_Mapping.xlsx:Config_Name_Mapping",
                legacy_protocol="vm33_http_json",
    ...
    return {
        "generated_from": {
            "sources": [
                ...
                "docs/workspace/legacy-migration/evidence/*.xlsx",
                "docs/workspace/legacy-migration/evidence/*.md",
                "docs/workspace/legacy-migration/plans/*.md",
                "docs/workspace/legacy-migration/plans/AXTP_Legacy_Migration_Matrix.xlsx",
            ],
            "policy": {
...
Provide a C++ legacy adapter skeleton that consumes `docs/workspace/legacy-migration/generated/legacy-to-axtp-map.generated.yaml` and exposes LEGACY_PROTOCOLS traffic as AXTP v1 RPC/Event/STREAM operations.
