...
| 2 | [Roadmap](../product/roadmap.md) | 了解阶段规划；记住它不是 runtime 合同。 |
| 3 | [Domain/Feature Classification](../../specs/0-principles/03-Domain-Feature-Classification.md) | 判断需求归属和能力边界。 |
| 4 | [Business Input](../workspace/business/README.md) | 查看或补充业务需求输入。 |
| 5 | [Flows](../workspace/flows/README.md) | 查看场景流程和协议覆盖。 |
...
| 是否已有 generated 能力？ | 看 [generated protocol](../../contract/generated/protocol.md) 和 [Product Domain Status](../product/domain-status.md)。 |
| 是否需要新 flow？ | 跨多个角色、多条消息或有异常路径时，优先写 `docs/workspace/flows/**`。 |
| 是否需要新草案？ | generated 不覆盖，且 flow 识别出协议缺口时，进入 `docs/workspace/protocol/**`。 |
...
| 单个 `docs/workspace/protocol/**` 草案 | 容易只看到局部，不知道 domain 整体状态。 |
