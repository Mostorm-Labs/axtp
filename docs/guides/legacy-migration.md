...
| 顺序 | 文档 | 读它的目的 |
|---:|---|---|
| 1 | [Legacy Migration README](../legacy-migration/README.md) | 了解 legacy 工作区目录和非合同边界。 |
| 2 | [Migration Dashboard](../legacy-migration/MIGRATION_DASHBOARD.md) | 按来源查看迁移总览、阻塞项和 next step。 |
| 3 | [Classification README](../legacy-migration/classification/README.md) | 了解分类输出和使用方式。 |
| 4 | [Plans](../legacy-migration/plans/README.md) | 查看迁移计划入口。 |
| 5 | [Domain/Feature Classification](../architecture/domain-feature-classification.md) | 按新协议语义判断 domain / feature。 |
...
6. 如果还未 generated，进入 `docs/flows/**` 或 `docs/protocol/**`。
