...
runtime 不得从 draft-only docs/protocol/** 实现正式能力。
```
...
| Protocol IR | [../../protocol/axtp.protocol.yaml](../../protocol/axtp.protocol.yaml) | 机器可读协议模型。 |
| Generated JSON | [../generated/protocol.json](../generated/protocol.json) | SDK、mock server、自动化测试读取。 |
| Generated Markdown | [../generated/protocol.md](../generated/protocol.md) | 人工联调和字段核对。 |
