...
| `mtu` | `0x06` | `2500` | `06 02 09 c4` | transport 建议 MTU |
...
| MessageId | `0x0001` |
| PayloadLength | `29` |
| CRC16-CCITT-FALSE | `0x1ba1`，Big-Endian / network byte order 写入 `1b a1` |

```text
Header:
41 58 01 01 00 1d 01 02 00 01 00 01
...
Full packet:
41 58 01 01 00 1d 01 02 00 01 00 01
01 00 01 00 00 02 01 01 04 02 10 00 06 02 09 c4
07 01 07 08 01 09 0a 02 03 e8 0b 01 00 1b a1
```
...
| `mtu` | `0x06` | `2500` | `06 02 09 c4` | 最终可用 MTU |
...
| MessageId | `0x0002` |
| PayloadLength | `35` |
| CRC16-CCITT-FALSE | `0x4f35`，Big-Endian / network byte order 写入 `4f 35` |

```text
Header:
41 58 01 01 00 23 02 01 00 02 00 01
...
Full packet:
41 58 01 01 00 23 02 01 00 02 00 01
02 00 01 00 00 01 04 12 34 56 78 02 01 01
04 02 10 00 06 02 09 c4 07 01 07 1e 01 01
0a 02 03 e8 0b 01 00 4f 35
```
...
```text
Header:
41 58 01 02 00 40 02 01 00 03 00 01
...
```text
Header:
41 58 01 02 00 3c 01 02 00 04 00 01
...
```text
Header:
41 58 01 02 00 35 02 01 00 05 00 01
