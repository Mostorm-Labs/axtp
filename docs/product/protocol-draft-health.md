...
|---|---|---:|---:|---:|---:|---:|---|---:|---:|---|
| audio | 旁路高覆盖 / P0 stream | 12 | 2 | 13 | 54 | 54/54 | ASK 3 / DRAFT 5 / FIX 0 / BLOCKER 0 | 0 | 0 | 确认 REVIEW-ASK |
| auth | 待排期 | 3 | 0 | 0 | 12 | 12/12 | ASK 0 / DRAFT 0 / FIX 0 / BLOCKER 0 | 0 | 0 | 可排采纳评审 |
| camera | P3/P4 | 7 | 0 | 0 | 40 | 40/40 | ASK 32 / DRAFT 49 / FIX 0 / BLOCKER 0 | 0 | 0 | 确认 REVIEW-ASK |
...
| firmware | 旁路高覆盖 | 3 | 1 | 6 | 7 | 7/7 | ASK 10 / DRAFT 1 / FIX 0 / BLOCKER 0 | 0 | 0 | 确认 REVIEW-ASK |
...
| network | 旁路高覆盖 | 6 | 4 | 26 | 24 | 24/24 | ASK 15 / DRAFT 18 / FIX 0 / BLOCKER 0 | 0 | 0 | 确认 REVIEW-ASK |
...
| software | P7 | 2 | 0 | 0 | 6 | 6/6 | ASK 14 / DRAFT 17 / FIX 0 / BLOCKER 0 | 0 | 0 | 确认 REVIEW-ASK |
...
| system | P1 | 6 | 0 | 0 | 29 | 29/29 | ASK 0 / DRAFT 0 / FIX 0 / BLOCKER 0 | 0 | 0 | 可排采纳评审 |
| video | P0 stream | 12 | 1 | 9 | 51 | 51/51 | ASK 9 / DRAFT 13 / FIX 0 / BLOCKER 0 | 0 | 0 | 确认 REVIEW-ASK |
...
|---|---|---|---:|---:|---:|---|---:|
| `workspace/protocol/video/video.stream.md` | P0 stream | video | 6 | 0 | 0 | ASK 5 / DRAFT 5 / FIX 0 / BLOCKER 0 | 958 |
| `workspace/protocol/audio/audio.stream.md` | 旁路高覆盖 / P0 stream | audio | 5 | 0 | 0 | ASK 3 / DRAFT 5 / FIX 0 / BLOCKER 0 | 921 |
...
| `workspace/protocol/firmware/firmware.update.md` | 旁路高覆盖 | firmware | 4 | 0 | 0 | ASK 10 / DRAFT 1 / FIX 0 / BLOCKER 0 | 871 |
| `workspace/protocol/network/network.ip.md` | 旁路高覆盖 | network | 2 | 0 | 0 | ASK 8 / DRAFT 3 / FIX 0 / BLOCKER 0 | 625 |
...
| `workspace/protocol/camera/camera.ptz.md` | P3/P4 | camera | 7 | 0 | 0 | ASK 10 / DRAFT 6 / FIX 0 / BLOCKER 0 | 931 |
...
| `workspace/protocol/software/software.config.md` | P7 | software | 3 | 0 | 0 | ASK 8 / DRAFT 9 / FIX 0 / BLOCKER 0 | 701 |
...
|---|---|---:|---:|---:|---|---:|
| `workspace/protocol/camera/camera.ptz.md` | camera | 7 | 0 | 0 | ASK 10 / DRAFT 6 / FIX 0 / BLOCKER 0 | 931 |
| `workspace/protocol/firmware/firmware.update.md` | firmware | 4 | 0 | 0 | ASK 10 / DRAFT 1 / FIX 0 / BLOCKER 0 | 871 |
| `workspace/protocol/software/software.config.md` | software | 3 | 0 | 0 | ASK 8 / DRAFT 9 / FIX 0 / BLOCKER 0 | 701 |
| `workspace/protocol/network/network.ip.md` | network | 2 | 0 | 0 | ASK 8 / DRAFT 3 / FIX 0 / BLOCKER 0 | 625 |
...
| `workspace/protocol/video/video.stream.md` | video | 6 | 0 | 0 | ASK 5 / DRAFT 5 / FIX 0 / BLOCKER 0 | 958 |
...
| `workspace/protocol/audio/audio.stream.md` | audio | 5 | 0 | 0 | ASK 3 / DRAFT 5 / FIX 0 / BLOCKER 0 | 921 |
