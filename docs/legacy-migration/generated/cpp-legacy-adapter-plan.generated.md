...
Provide a C++ legacy adapter skeleton that consumes `docs/legacy-migration/generated/legacy-to-axtp-map.generated.yaml` and exposes AXDP HID and signage SDK traffic as AXTP v1 RPC/Event/STREAM operations.
