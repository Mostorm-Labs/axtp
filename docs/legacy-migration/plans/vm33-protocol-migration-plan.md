...
> Source evidence: `docs/legacy-migration/evidence/VM33协议文档.md`
> Classification reference: `docs/legacy-migration/classification/by-source/vm33_http_json.md`
...
| 旧迁移产物 | `AXTP_Legacy_Migration_Matrix.xlsx`、`docs/legacy-migration/generated/**` 和旧 VM33 分类材料保留为证据和参考，不作为 VM33 Pro 新协议事实源。 |
...
- 不修改 `docs/legacy-migration/evidence/VM33协议文档.md`。
- 不修改已有老 VM33 迁移矩阵、旧分类产物或 `docs/legacy-migration/generated/**`。
...
`docs/legacy-migration/classification/by-source/vm33_http_json.md` 已把旧 VM33 条目归入候选 AXTP domain.feature。示例：
