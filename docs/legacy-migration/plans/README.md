...
- Use `93_Feature分类参考` as the shared catalog from `docs/specs/2-registry/01-Naming-and-Taxonomy.md`.
...
- Do not manually edit files under `docs/generated/`, `docs/legacy-migration/generated/`, or runtime generated headers.
