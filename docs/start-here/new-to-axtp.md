...
| 2 | [../specs/0-principles/01-Glossary.md](../specs/0-principles/01-Glossary.md) | 统一 `CONTROL`、`RPC`、`STREAM`、Session、Frame 等术语。 |
| 3 | [../specs/1-core/01-Overview.md](../specs/1-core/01-Overview.md) | 看懂核心分层和两条连接路径。 |
| 4 | [../generated/protocol.md](../generated/protocol.md) | 查看当前已经生成、可实现的协议参考。 |
| 5 | [../README.md](../README.md) | 按角色选择产品、研发、测试或维护者路径。 |
...
如果你是研发，先转到 [Runtime / SDK 入口](runtime-implementer.md)，再按 [Quickstart](../guides/quickstart.md) 选择 TCP Standard Framed 或 WS JSON 路径。
