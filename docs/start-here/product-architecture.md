...
你不需要从 wire format 或 YAML 开始。先看 roadmap、domain 状态、分类边界、业务输入和 flows。

## 先理解什么

| 材料 | 作用 |
|---|---|
| Roadmap | 说明阶段目标和规划优先级。 |
| Domain 状态矩阵 | 说明哪些 domain 已 generated，哪些仍是草案。 |
...
| 顺序 | 文档 | 读它的目的 |
|---:|---|---|
| 1 | [../../ROADMAP.md](../../ROADMAP.md) | 了解阶段规划和优先级。 |
| 2 | [../protocol/README.md#domain-状态矩阵](../protocol/README.md#domain-状态矩阵) | 查看 domain 生成状态和下一步动作。 |
...
| 是否已有 generated 能力？ | 看 [generated 协议参考](../generated/protocol.md) 和 [Domain 状态矩阵](../protocol/README.md#domain-状态矩阵)。 |
