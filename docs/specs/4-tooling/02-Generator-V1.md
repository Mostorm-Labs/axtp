...
2. Generator MUST NOT 从 `docs/generated/**`、`docs/protocol/**`、appendix 或 runtime generated files 反推 source facts。
3. `protocol/axtp.protocol.yaml`、`docs/generated/**`、runtime generated outputs 和 `tooling/mcp/*.generated.json` MUST 被视为 generated artifacts，不得手写修改。
...
| 输入 | 用途 |
|---|---|
| `registry/core/**` | core enum/opcode/encoding 事实 |
| `registry/error/**` | error 事实 |
| `registry/schema/**` | shared schema 事实 |
| `registry/capability/**` | shared capability/profile 事实 |
| `registry/domains/**` | business domain 事实 |
| `registry/version.yaml` | version 元数据 |

输出：

| 输出 | 类型 | 手写 |
|---|---|---|
| `protocol/axtp.protocol.yaml` | Protocol IR | MUST NOT |
| `docs/generated/protocol.md` | 人可读 generated reference | MUST NOT |
| `docs/generated/protocol.json` | 机器可读 generated reference | MUST NOT |
| `tooling/mcp/*.generated.json` | tooling generated 数据 | MUST NOT |
...
Codex skill workflow 属于 `docs/dev/skills/**`，不是 generator 的规范性行为。更丰富的 runtime codegen、docs UX 改进、compatibility dashboard 和 generated source manifest 等 P1/P2 roadmap 项，在实现并采纳前应保持为 future/tooling planning。
