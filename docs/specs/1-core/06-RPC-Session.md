...
| `7` | `Request` | Logical Client -> Logical Server | 业务 method 调用 |
| `8` | `RequestResponse` | Logical Server -> Logical Client | 业务 method 结果或错误 |
...
| `7` | `Request` | Client -> Server | 必需 |
| `8` | `RequestResponse` | Server -> Client | 必需 |
| `9` | `RequestBatch` | Client -> Server | 可选 |
| `10` | `RequestBatchResponse` | Server -> Client | 可选 |
| `11` | - | - | 保留 |
| `12` | - | - | 保留 |
| `13` | - | - | 保留 |
...
| JSON_BINARY | uint32 Little-Endian |
...
RPC_IDENTIFYING
  -> Identified received
APP_READY
  -> Request / RequestResponse / Event / optional Reidentify
...
- JSON_BINARY 多字节字段为 Little-Endian；
