...
6. Confirm `docs/workspace/legacy-migration/plans/` legacy mapping and migration notes are updated when legacy behavior changes.
7. Confirm `docs/workspace/release/CHANGELOG.md` records the release under `spec/vX.Y.Z`.
...
- Compatibility notes
- Runtime impact
- Links to `docs/workspace/release/CHANGELOG.md` and relevant generated protocol docs
