...
6. 如果 legacy 行为变化，确认 `docs/workspace/legacy-migration/plans/` 中 legacy 映射和迁移说明已经更新。
7. 确认 `docs/workspace/release/CHANGELOG.md` 已在 `spec/vX.Y.Z` 下记录本次发布。
...
- Compatibility notes
- Runtime impact
- `docs/workspace/release/CHANGELOG.md` 和相关 generated protocol docs 链接
