...
| UI 需要新增算法对象或新字段 | adopted | `audio.algorithm` schema extension | `contract/registry/domains/audio/domain.yaml`, `docs/workspace/protocol/audio/audio.algorithm.md` | 转 `amend-adopted-protocol`。 |
