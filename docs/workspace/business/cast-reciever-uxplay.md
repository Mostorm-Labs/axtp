...
- `docs/workspace/legacy-migration/evidence/websocket_protocol.md`
...
- 交互和协议覆盖由 `docs/workspace/flows/cast-reciever-uxplay.md` 承接。
- Flow 识别出的协议缺口再进入 `docs/workspace/protocol/**` 草案。
