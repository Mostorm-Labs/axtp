...
`docs/workspace/` groups materials that help maintain the AXTP spec lifecycle but are not runtime implementation contracts.
...
| [release/](release/README.md) | Changelog, versioning, release checklist, spec lock, and runtime update flow. | No, except for version binding |
...
Stable implementation facts remain in `../../specs/`, `../../contract/registry/**`, `../../contract/protocol/axtp.protocol.yaml`, `../../contract/generated/**`, and `../../conformance/**`.
