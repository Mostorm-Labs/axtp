...
`network.ap` 的 P0 / confirmed subset 已进入 generated 合同；正式 methodId、eventId、errorCode、fieldId 以 `registry/**`、`protocol/axtp.protocol.yaml` 和 `docs/generated/**` 为准。本文保留的 review 标记仅用于后续修订。
