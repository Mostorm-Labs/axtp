...
domain: device
feature: device.info
registry: ../../../registry/domains/device/domain.yaml
...
| 当前状态 | generated；已写入 `../../../registry/domains/device/domain.yaml`，并已刷新到 `protocol/axtp.protocol.yaml` 与 `docs/generated/**`。 |
...
| 项 | 状态 | 说明 |
|---|---|---|
| registry | source adopted | 已写入 `../../../registry/domains/device/domain.yaml`。 |
...
| registry readiness | ready | device.info P0/confirmed subset 已写入 registry source；enum baseline 和 legacyRefs 仍保留待确认。 |
