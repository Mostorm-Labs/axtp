...
| 当前状态 | draft；由 `docs/business/video-framing-modes.md` 和 `docs/flows/video-framing-modes.md` 转入。 |
...
本文只描述 `video.framing` 草案。稳定事实必须写入 `registry/domains/video/domain.yaml` 后再由 Generator 生成。
...
| 项 | 状态 | 说明 |
|---|---|---|
| registry | not generated | `registry/domains/video/domain.yaml` 尚未包含 `video.framing` 正式事实。 |
| generated | false | `docs/generated/protocol.md` 无 `video.framing` methods/events。 |
