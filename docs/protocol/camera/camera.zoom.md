...
| 当前状态 | draft；由 `docs/business/camera-lens-control.md` 和 `docs/flows/camera-lens-control.md` 转入。 |
...
| 项 | 状态 | 说明 |
|---|---|---|
| registry | not generated | `registry/domains/camera/domain.yaml` 尚未包含 `camera.zoom`。 |
