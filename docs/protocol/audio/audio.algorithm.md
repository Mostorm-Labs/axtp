...
| `audio.getAlgorithmConfig` / `audio.setAlgorithmConfig` | 见 `docs/specs/10-AXTP-Methods-Registry-Spec.md`。 |
| `audio.algorithmConfigChanged` | 见 `docs/specs/11-AXTP-Events-Registry-Spec.md`。 |
| `audio.getAlgorithmCapabilities` / `audio.resetAlgorithmConfig` | 见 `docs/specs/08-AXTP-Capability-Naming-and-Feature-Taxonomy.md` 的配置型 feature 模板；落 registry 时需补齐 method registry 条目。 |
