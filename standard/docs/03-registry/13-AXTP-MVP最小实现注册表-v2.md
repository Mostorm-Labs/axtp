...
|---:|---|---|---|
| `0x0001` | `protocol.payload.control` | `bool` | 必须 |
| `0x0002` | `protocol.payload.rpc` | `bool` | 必须 |
| `0x0003` | `protocol.payload.stream` | `bool` | 必须 |
| `0x0101` | `device.info` | `bool` | 必须 |
| `0x0301` | `capability.get` | `bool` | 必须 |
| `0x0601` | `display.brightness` | `bool` | 必须 |
| `0x0602` | `display.brightnessMin` | `uint16` | 必须 |
| `0x0603` | `display.brightnessMax` | `uint16` | 必须 |
| `0x0604` | `display.brightnessStep` | `uint16` | 必须 |
| `0x0B01` | `firmware.ota` | `object` | 必须 |
