...
> Source inputs: `workspace/business/cast-reciever-uxplay.md`, `workspace/legacy-migration/evidence/WEBSOCKET_PROTOCOL.md`, `contract/generated/protocol.md`, `workspace/protocol/auth/auth.session.md`, `workspace/protocol/auth/auth.token.md`, `workspace/protocol/auth/auth.permission.md`
...
| mDNS 发现和 AirPlay 媒体传输 | non-protocol | AirPlay/UxPlay implementation detail | `workspace/business/cast-reciever-uxplay.md` | 不进入 AXTP cast 控制协议。 |
