...
已生成 method 以 contract/registry/generated 为准。本 feature 采用复杂 schema 模式：method 下只写 schema 名称、字段定义位置和交互语义，完整字段表集中在第 6 章维护。
...
| 项 | 状态 | 说明 |
|---|---|---|
| registry | generated | [contract/registry/domains/audio/domain.yaml](../../../contract/registry/domains/audio/domain.yaml) 已包含 methods、event、types、capability。 |
| generated | true | [method registry](../../../contract/generated/method_registry.generated.md)、[event registry](../../../contract/generated/event_registry.generated.md)、[capability registry](../../../contract/generated/capability_registry.generated.md) 已生成。 |
...
| compatibility | runtime 应绑定 contract/registry/generated 或明确 spec tag/commit，不依赖本文 prose 作为唯一事实源。 |
