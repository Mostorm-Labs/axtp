...
本文是维护者规划参考，不是 runtime 或 release 合同。稳定 method、event、schema、error 和 capability 机器事实仍以 `contract/registry/**/*.yaml`、`contract/registry/domains/**/*.yaml`、`contract/protocol/axtp.protocol.yaml` 和 `contract/generated/**` 为准。命名模板和正式 registry 规则以 `specs/30-registry.md` 为准。
